...
url = "https://music.163.com/weapi/song/enhance/player/url/v1?csrf_token=985eb2fde4e1bd422dcd8f3defbb5889"

ming_ = {
    "csrf_token": "985eb2fde4e1bd422dcd8f3defbb5889",
    "encodeType": "aac",
    "ids": "[1325905146]",
    "level": "standard"
}

ming_s = json.dumps(ming_, separators=(',', ':'))
# {"csrf_token": "985eb2fde4e1bd422dcd8f3defbb5889", "encodeType": "aac", "ids": "[1325905146]", "level": "standard"}
# {"csrf_token":"985eb2fde4e1bd422dcd8f3defbb5889","encodeType":"aac","ids":"[1325905146]","level":"standard"}
# print(ming_s)
...
# 使用方案:
# 1. 读取js代码
f = open("复刻网易的js.js", mode="r", encoding="utf-8")
js_code = f.read()
# 2. 预加载
js = execjs.compile(js_code)
# 3. 调用函数, 关于参数和返回值的数据类型你完全不用管
# python字典 <=> js对象
...
# print(resp.json())  # 不做任何校验,直接拿json
print(resp.text)
