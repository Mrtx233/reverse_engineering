...
// globalThis在浏览器里表示全局,  在node环境下也是全局


debugger;
var window = globalThis; // 在node环境下, global是全局对象
...
var TOKEN_SERVER_TIME = 1734352920.877;
!function(n, t) {
    !function() {
        var r, e, a;
        r = e = a = n;
...
// document.cookie里面应该有值.. -> 猜的...
// XMLHttpRequest.prototype.open 被hook
// 发请求就会自动执行该代码
// XMLHttpRequest.prototype.open运行完成之后
// 会有新cookie
