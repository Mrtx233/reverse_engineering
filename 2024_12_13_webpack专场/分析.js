(()=>{
    var t = {
                  ...
                  , v = r.AES = e.extend({
                    _doReset: function() {
                        if (!this._nRounds || this._keyPriorReset !== this._key) {
                            for (var t = this._keyPriorReset = this._key, e = t.words, r = t.sigBytes / 4, i = 4 * ((this._nRounds = r + 6) + 1), o = this._keySchedule = [], s = 0; s < i; s++)
                                s < r ? o[s] = e[s] : (h = o[s - 1],
                    ...
                    _doCryptBlock: function(t, e, r, i, n, o, s, a) {
                        for (var c = this._nRounds, h = t[e] ^ r[0], f = t[e + 1] ^ r[1], l = t[e + 2] ^ r[2], u = t[e + 3] ^ r[3], d = 4, p = 1; p < c; p++) {
                            var v = i[h >>> 24] ^ n[f >>> 16 & 255] ^ o[l >>> 8 & 255] ^ s[255 & u] ^ r[d++]
                              , _ = i[f >>> 24] ^ n[l >>> 16 & 255] ^ o[u >>> 8 & 255] ^ s[255 & h] ^ r[d++]
                        ...
                        v = (a[h >>> 24] << 24 | a[f >>> 16 & 255] << 16 | a[l >>> 8 & 255] << 8 | a[255 & u]) ^ r[d++],
                        _ = (a[f >>> 24] << 24 | a[l >>> 16 & 255] << 16 | a[u >>> 8 & 255] << 8 | a[255 & h]) ^ r[d++],
        ...
        109: function(t, e, r) {
            ...
            g = (n.format = {}).OpenSSL = {
                stringify: function(t) {
                    var e = t.ciphertext
                      , r = t.salt;
                    return (r ? a.create([1398893684, 1701076831]).concat(r).concat(e) : e).toString(f)
                },
                parse: function(t) {
                    var e, r = f.parse(t), i = r.words;
            ...
            w = (n.kdf = {}).OpenSSL = {
                execute: function(t, e, r, i, n) {
                    ...
                    var s = a.create(o.words.slice(e), 4 * r);
            ...
            t.exports = (i = i || function(t, e) {
                ...
                var n = function() {
                  ...
                  , p = a.BufferedBlockAlgorithm = c.extend({
                    ...
                    _process: function(e) {
                        var r, i = this._data, n = i.words, o = i.sigBytes, s = this.blockSize, a = o / (4 * s), c = (a = e ? t.ceil(a) : t.max((0 | a) - this._minBufferSize, 0)) * s, f = t.min(4 * c, o);
                        if (c) {
                            for (var l = 0; l < c; l += s)
                ...
                var c = s.MD5 = o.extend({
                    ...
                    _doProcessBlock: function(t, e) {
                        ...
                        var o = this._hash.words
                          ...
                          , R = o[3];
                        H = h(H, z, C, R, s, 7, a[0]),
                        R = h(R, H, z, C, c, 12, a[1]),
                        C = h(C, R, H, z, d, 17, a[2]),
                        z = h(z, C, R, H, p, 22, a[3]),
                        H = h(H, z, C, R, v, 7, a[4]),
                        R = h(R, H, z, C, _, 12, a[5]),
                        C = h(C, R, H, z, y, 17, a[6]),
                        z = h(z, C, R, H, g, 22, a[7]),
                        H = h(H, z, C, R, B, 7, a[8]),
                        R = h(R, H, z, C, w, 12, a[9]),
                        C = h(C, R, H, z, k, 17, a[10]),
                        z = h(z, C, R, H, x, 22, a[11]),
                        H = h(H, z, C, R, b, 7, a[12]),
                        R = h(R, H, z, C, S, 12, a[13]),
                        C = h(C, R, H, z, m, 17, a[14]),
                        H = f(H, z = h(z, C, R, H, A, 22, a[15]), C, R, c, 5, a[16]),
                        R = f(R, H, z, C, y, 9, a[17]),
                        C = f(C, R, H, z, x, 14, a[18]),
                        z = f(z, C, R, H, s, 20, a[19]),
                        H = f(H, z, C, R, _, 5, a[20]),
                        R = f(R, H, z, C, k, 9, a[21]),
                        C = f(C, R, H, z, A, 14, a[22]),
                        z = f(z, C, R, H, v, 20, a[23]),
                        H = f(H, z, C, R, w, 5, a[24]),
                        R = f(R, H, z, C, m, 9, a[25]),
                        C = f(C, R, H, z, p, 14, a[26]),
                        z = f(z, C, R, H, B, 20, a[27]),
                        H = f(H, z, C, R, S, 5, a[28]),
                        R = f(R, H, z, C, d, 9, a[29]),
                        C = f(C, R, H, z, g, 14, a[30]),
                        H = l(H, z = f(z, C, R, H, b, 20, a[31]), C, R, _, 4, a[32]),
                        R = l(R, H, z, C, B, 11, a[33]),
                        C = l(C, R, H, z, x, 16, a[34]),
                        z = l(z, C, R, H, m, 23, a[35]),
                        H = l(H, z, C, R, c, 4, a[36]),
                        R = l(R, H, z, C, v, 11, a[37]),
                        C = l(C, R, H, z, g, 16, a[38]),
                        z = l(z, C, R, H, k, 23, a[39]),
                        H = l(H, z, C, R, S, 4, a[40]),
                        R = l(R, H, z, C, s, 11, a[41]),
                        C = l(C, R, H, z, p, 16, a[42]),
                        z = l(z, C, R, H, y, 23, a[43]),
                        H = l(H, z, C, R, w, 4, a[44]),
                        R = l(R, H, z, C, b, 11, a[45]),
                        C = l(C, R, H, z, A, 16, a[46]),
                        H = u(H, z = l(z, C, R, H, d, 23, a[47]), C, R, s, 6, a[48]),
                        R = u(R, H, z, C, g, 10, a[49]),
                        C = u(C, R, H, z, m, 15, a[50]),
                        z = u(z, C, R, H, _, 21, a[51]),
                        H = u(H, z, C, R, b, 6, a[52]),
                        R = u(R, H, z, C, p, 10, a[53]),
                        C = u(C, R, H, z, k, 15, a[54]),
                        z = u(z, C, R, H, c, 21, a[55]),
                        H = u(H, z, C, R, B, 6, a[56]),
                        R = u(R, H, z, C, A, 10, a[57]),
                        C = u(C, R, H, z, y, 15, a[58]),
                        z = u(z, C, R, H, S, 21, a[59]),
                        H = u(H, z, C, R, v, 6, a[60]),
                        R = u(R, H, z, C, x, 10, a[61]),
                        C = u(C, R, H, z, d, 15, a[62]),
                        z = u(z, C, R, H, w, 21, a[63]),
                        o[0] = o[0] + H | 0,
                        o[1] = o[1] + z | 0,
                        o[2] = o[2] + C | 0,
                        o[3] = o[3] + R | 0
        ...
        242: function(t, e, r) {
            ...
            t.exports = (o = r(249),
            r(109),
            o.mode.CTR = (n = (i = o.lib.BlockCipherMode.extend()).Encryptor = i.extend({
        ...
        148: function(t, e, r) {
            ...
            t.exports = (n = r(249),
            r(109),
            n.mode.ECB = ((i = n.lib.BlockCipherMode.extend()).Encryptor = i.extend({
                processBlock: function(t, e) {
        ...
        112: function(t, e, r) {
            ...
            f = a.PBKDF2 = o.extend({
                ...
                compute: function(t, e) {
                    for (var r = this.cfg, i = h.create(r.hasher, t), n = s.create(), o = s.create([1]), a = n.words, c = o.words, f = r.keySize, l = r.iterations; a.length < f; ) {
                ...
                var e = i
                  ...
                  , d = s.RIPEMD160 = o.extend({
                    ...
                    _doProcessBlock: function(t, e) {
                        ...
                        var o, s, d, w, k, x, b, S, m, A, H, z = this._hash.words, C = l.words, R = u.words, E = a.words, D = c.words, M = h.words, P = f.words;
                        for (x = o = z[0],
                        b = s = z[1],
                        S = d = z[2],
                        m = w = z[3],
                        ...
                        r = 0; r < 80; r += 1)
                            H = o + t[e + E[r]] | 0,
                            H += r < 16 ? p(s, d, w) + C[0] : r < 32 ? v(s, d, w) + C[1] : r < 48 ? _(s, d, w) + C[2] : r < 64 ? y(s, d, w) + C[3] : g(s, d, w) + C[4],
                            H = (H = B(H |= 0, M[r])) + k | 0,
                            o = k,
                            k = w,
                            w = B(d, 10),
                            ...
                            s = H,
                            H = x + t[e + D[r]] | 0,
                            H += r < 16 ? g(b, S, m) + R[0] : r < 32 ? y(b, S, m) + R[1] : r < 48 ? _(b, S, m) + R[2] : r < 64 ? v(b, S, m) + R[3] : p(b, S, m) + R[4],
                            H = (H = B(H |= 0, P[r])) + A | 0,
                            x = A,
                            A = m,
                            m = B(S, 10),
            ...
            h = a.SHA1 = s.extend({
                ...
                _doProcessBlock: function(t, e) {
                    for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], a = r[4], h = 0; h < 80; h++) {
                        ...
                        l += h < 20 ? 1518500249 + (n & o | ~n & s) : h < 40 ? 1859775393 + (n ^ o ^ s) : h < 60 ? (n & o | n & s | o & s) - 1894007588 : (n ^ o ^ s) - 899497514,
                        a = s,
                        s = o,
                        o = n << 30 | n >>> 2,
                        n = i,
                            ...
                            u = 0; u < 5; u++)
                                for (v = 0; v < 5; v++) {
                                    var z = r[k = u + 5 * v]
                                      ...
                                      , R = l[(u + 1) % 5 + 5 * v]
                                      , E = l[(u + 2) % 5 + 5 * v];
                                    z.high = C.high ^ ~R.high & E.high,
                                    z.low = C.low ^ ~R.low & E.low
                                }
                            z = r[0];
                            var D = f[a];
                            z.high ^= D.high,
        ...
        460: function(t, e, r) {
            ...
            i.SHA384 = c._createHelper(h),
            i.HmacSHA384 = c._createHmacHelper(h),
            f.SHA384)
        },
        34: function(t, e, r) {
            var i;
            ...
            function() {
                ...
                var f = s.SHA512 = e.extend({
                    ...
                    _doProcessBlock: function(t, e) {
                        for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], a = r[4], f = r[5], l = r[6], u = r[7], d = i.high, p = i.low, v = n.high, _ = n.low, y = o.high, g = o.low, B = s.high, w = s.low, k = a.high, x = a.low, b = f.high, S = f.low, m = l.high, A = l.low, H = u.high, z = u.low, C = d, R = p, E = v, D = _, M = y, P = g, F = B, W = w, O = k, U = x, I = b, K = S, X = m, L = A, T = H, j = z, N = 0; N < 80; N++) {
                            var Z, q, G = h[N];
                            if (N < 16)
                                q = G.high = 0 | t[e + 2 * N],
                                Z = G.low = 0 | t[e + 2 * N + 1];
                                ...
                                var V = h[N - 15]
                                  ...
                                  , ht = ct.high
                                  , ft = ct.low;
                                q = (q = (q = Y + st + ((Z = $ + at) >>> 0 < $ >>> 0 ? 1 : 0)) + it + ((Z += nt) >>> 0 < nt >>> 0 ? 1 : 0)) + ht + ((Z += ft) >>> 0 < ft >>> 0 ? 1 : 0),
                                G.high = q,
                                G.low = Z
                            }
                            var lt, ut = O & I ^ ~O & X, dt = U & K ^ ~U & L, pt = C & E ^ C & M ^ E & M, vt = R & D ^ R & P ^ D & P, _t = (C >>> 28 | R << 4) ^ (C << 30 | R >>> 2) ^ (C << 25 | R >>> 7), yt = (R >>> 28 | C << 4) ^ (R << 30 | C >>> 2) ^ (R << 25 | C >>> 7), gt = (O >>> 14 | U << 18) ^ (O >>> 18 | U << 14) ^ (O << 23 | U >>> 9), Bt = (U >>> 14 | O << 18) ^ (U >>> 18 | O << 14) ^ (U << 23 | O >>> 9), wt = c[N], kt = wt.high, xt = wt.low, bt = T + gt + ((lt = j + Bt) >>> 0 < j >>> 0 ? 1 : 0), St = yt + vt;
                            T = X,
                            j = L,
                            X = I,
                            L = K,
                            I = O,
                            K = U,
                            O = F + (bt = (bt = (bt = bt + ut + ((lt += dt) >>> 0 < dt >>> 0 ? 1 : 0)) + kt + ((lt += xt) >>> 0 < xt >>> 0 ? 1 : 0)) + q + ((lt += Z) >>> 0 < Z >>> 0 ? 1 : 0)) + ((U = W + lt | 0) >>> 0 < W >>> 0 ? 1 : 0) | 0,
                            F = M,
                            W = P,
                            M = E,
                            P = D,
                            E = C,
                            D = R,
                            C = bt + (_t + pt + (St >>> 0 < yt >>> 0 ? 1 : 0)) + ((R = lt + St | 0) >>> 0 < lt >>> 0 ? 1 : 0) | 0
                        }
                        p = i.low = p + R,
                        i.high = d + C + (p >>> 0 < R >>> 0 ? 1 : 0),
                        _ = n.low = _ + D,
                        n.high = v + E + (_ >>> 0 < D >>> 0 ? 1 : 0),
                        g = o.low = g + P,
                        o.high = y + M + (g >>> 0 < P >>> 0 ? 1 : 0),
                        w = s.low = w + W,
                        s.high = B + F + (w >>> 0 < W >>> 0 ? 1 : 0),
                        x = a.low = x + U,
                        a.high = k + O + (x >>> 0 < U >>> 0 ? 1 : 0),
                        S = f.low = S + K,
                        f.high = b + I + (S >>> 0 < K >>> 0 ? 1 : 0),
                        A = l.low = A + L,
                        l.high = m + X + (A >>> 0 < L >>> 0 ? 1 : 0),
                        z = u.low = z + j,
                        u.high = H + T + (z >>> 0 < j >>> 0 ? 1 : 0)
                    },
                    _doFinalize: function() {
                        var t = this._data
                          , e = t.words
        ...
        191: t=>{
            t.exports = {
                chenv: function() {
                    return "undefined" == typeof window ? "fuck_env" : "ok_env"
                }
            }
        }
        ,
        // 482就是一个模块 -> 单独的空间. 不能和其他人起冲突
        // 本质和require是一样的....
        482: (t,e,r)=>{  // t是那个大对象 {exports:函数o}
            var i = r(191)
              , n = r(106);
            function o() {
                var t = i.chenv()
        ...
        106: (t,e,r)=>{
            ...
            t.exports = {
                encrypt: function(t) {
                    var e = i.enc.Utf8.parse("1234567887654321")
                      , r = i.enc.Utf8.parse("0000000000000000")
                      , n = i.enc.Utf8.parse(t);
                    return i.AES.encrypt(n, e, {
                        iv: r,
                        mode: i.mode.CBC,
                        packing: i.pad.Pkcs7
                    }).toString()
