...
my_env.plugins.def_obj_prop(window, "Image", true, false, true,
    function Image(){
        ...
        if(new.target){
            ...
            my_env.plugins.throw_error(TypeError, "Failed to construct 'Image': Please use the 'new' operator, this DOM object constructor cannot be called as a function.")
        }
    }
);
