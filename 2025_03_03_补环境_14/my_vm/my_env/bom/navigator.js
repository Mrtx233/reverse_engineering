...
my_env.plugins.def_obj_prop(Navigator.prototype, "getBattery", true, true, true,
    function getBattery() {
        return {
            // 7777 9999
            then: my_env.plugins.set_native(function then(func){
                // debugger; // navigator.getBattery().then(func);
                let obj = Object.create(BatteryManager.prototype);
                func(obj);
            })
        };
    },
...
navigator = my_env.plugins.obj_proxy(navigator, "navigator");
